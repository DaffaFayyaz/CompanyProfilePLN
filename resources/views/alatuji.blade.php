...
<section class="content">
    @foreach($fotoutamahalamans as $foto)
    <div class="
    relative h-[300px]
    lg:h-[400px]
    ">
        <div class="absolute inset-0 bg-cover bg-center shadow-md" style="background-image: url('{{ asset('storage/' . $foto->foto_alatuji) }}');">
...
<a href="{{url('/alatuji/excel/export')}}"><button class="mt-5 mx-10 shadow-md text-white bg-blue-700 p-2 rounded-lg duration-200">Export</button></a>
        ...
        <table class="w-full">
            <thead>
                <tr class="text-sm text-left bg-blue-700 text-white">
                    ...
                    <th class="p-3 tracking-wide whitespace-nowrap">Lokasi Alat Uji</th>
                    <th class="p-3 tracking-wide whitespace-nowrap">Nama Alat Uji</th>
                    <th class="p-3 tracking-wide whitespace-nowrap">Serial ID</th>
                    <th class="p-3 tracking-wide whitespace-nowrap">Tahun Buat</th>
                    <th class="p-3 tracking-wide whitespace-nowrap">Merk</th>
                    <th class="p-3 tracking-wide whitespace-nowrap">Tipe</th>
                    <th class="p-3 tracking-wide whitespace-nowrap">Kondisi</th>
                    <th class="p-3 tracking-wide whitespace-nowrap">Keterangan</th>
                    <th class="p-3 tracking-wide whitespace-nowrap">Jumlah Pemakaian TW 1 (2022)</th>
                    <th class="p-3 tracking-wide whitespace-nowrap">Tanggal Kalibrasi Akhir</th>
                    <th class="p-3 tracking-wide whitespace-nowrap">Sertifikat Kalibrasi</th>
                </tr>
            </thead>
            @php
                $counter = 1;
            ...
            <tr class="text-sm text-left bg-slate-50 border-b-2 border-gray-200">
                ...
                <td class="p-3 whitespace-nowrap">{{ $alatuji->lokasi_alat_uji }}</td>
                <td class="p-3 whitespace-nowrap">{{ $alatuji->nama_alat_uji }}</td>
                <td class="p-3 whitespace-nowrap">{{ $alatuji->serial_id }}</td>
                <td class="p-3 whitespace-nowrap">{{ $alatuji->tahun_buat }}</td>
                <td class="p-3 whitespace-nowrap">{{ $alatuji->merk }}</td>
                <td class="p-3 whitespace-nowrap">{{ $alatuji->tipe }}</td>
                <td class="p-3 whitespace-nowrap">{{ $alatuji->kondisi }}</td>
                <td class="p-3 whitespace-nowrap">{{ $alatuji->keterangan }}</td>
                <td class="p-3 whitespace-nowrap">{{ $alatuji->jumlah_pemakaian_tw_1 }}</td>
                <td class="p-3 whitespace-nowrap">{{ $alatuji->tanggal_kalibrasi_akhir }}</td>
                <td class="p-3 whitespace-nowrap">{{ $alatuji->sertifikat_kalibrasi }}</td>
            </tr>
            @endforeach
            @else
            <tr>
