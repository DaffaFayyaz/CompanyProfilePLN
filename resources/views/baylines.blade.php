...
<section class="content"> 
    ...
    ">
        ...
        <div class="absolute inset-0 bg-cover bg-center shadow-md" style="background-image: url('{{ asset('storage/' . $foto->foto_bayline) }}');">
...
" data-aos="fade-down" data-aos-duration="1000">
    ...
    <a href="{{url('/baylines/excel/export')}}"><button class="mt-5 mx-10 shadow-md text-white bg-blue-700 p-2 rounded-lg duration-200">Export</button></a>
        ...
        <table class="w-full">
            <thead>
                <tr class="text-sm text-left bg-blue-700 text-white">
                    ...
                    <th class="p-3 tracking-wide whitespace-nowrap">Kapasitas</th>
                    <th class="p-3 tracking-wide whitespace-nowrap">KV</th>
                </tr>
            </thead>
            @php
                $counter = 1;
            ...
            <tr class="text-sm text-left bg-slate-50 border-b-2 border-gray-200">
                ...
                <td class="p-3 whitespace-nowrap">{{ $bayline->gardu_induk }}</td>
                <td class="p-3 whitespace-nowrap">{{ $bayline->nama_bay }}</td>
                <td class="p-3 whitespace-nowrap">{{ $bayline->tahun_operasi }}</td>
                <td class="p-3 whitespace-nowrap">{{ $bayline->kapasitas }}</td>
                <td class="p-3 whitespace-nowrap">{{ $bayline->KV }}</td>
            </tr>
            @endforeach
            @else
            <tr class="text-sm text-left bg-slate-50 border-b-2 border-gray-200">
